...
export const PosPaymentDesktopTable = ({ data }) => {
          ...
          allOutlets.map((item, index) => {
            return (
              <DesktopTableRows index={index}>
                ...
                <DesktopTableCell data={item.posName} />
                <DesktopTableCell data={item.terminalID} />
...
export const PosPaymentMobileTable = ({ data }) => {
        ...
        allOutlets.map((item, index) => {
          return (
            <MobileTableRows index={index}>
              <MobileTableCell
                columns={["POS name", "Terminal ID"]}
                cellData={[item.posName, item.terminalID]}
              />
              <MobileTableCell
