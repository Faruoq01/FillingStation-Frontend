...
const SalaryModal = (props) => {
  ...
  const submit = () => {
    ...
    if (position === "")
      return swal("Warning!", "Position field cannot be empty", "info");
    if (level === "")
      return swal("Warning!", "Level field cannot be empty", "info");
    if (low === "")
      return swal("Warning!", "Low range field cannot be empty", "info");
    if (high === "")
      return swal("Warning!", "High range field cannot be empty", "info");
    ...
    SalaryService.createSalary(payload)
      .then((data) => {
