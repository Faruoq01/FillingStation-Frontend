...
const UpdateDipping = (props) => {
  ...
  const submit = () => {
    if (currentLevel === "")
      return swal("Warning!", "Current tank level cannot be empty", "info");
    if (dipping === "")
      return swal("Warning!", "Dipping amount cannot be empty", "info");
    setLoading(true);
    ...
    APIs.post("/comprehensive/update-dipping", payload)
      .then(() => {
