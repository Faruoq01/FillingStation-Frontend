...
const UpdateExpenses = (props) => {
  ...
  const submit = () => {
    if (expenseName === "")
      return swal("Warning!", "Expense name cannot be empty", "info");
    if (expenseAmount === "")
      return swal("Warning!", "Expense amount cannot be empty", "info");
    setLoading(true);
    ...
    APIs.post("/comprehensive/update-expenses", payload)
      .then(() => {
