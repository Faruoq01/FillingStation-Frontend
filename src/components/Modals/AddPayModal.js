...
const AddPayModal = (props) => {
    ...
    const submit = async() => {
        ...
        if(bankName === 'null' && posName === 'null') return swal("Warning!", "Please fill payment details!", "info");
        if(tellerNumber === 'null' && terminalID === 'null') return swal("Warning!", "Please fill teller or terminal details!", "info");
        if(amountPaid === '') return swal("Warning!", "Please enter amount paid", "info");
        if(date === '') return swal("Warning!", "Please enter a payment date!", "info");
        if(cam === 'null' && gall === "null") return swal("Warning!", "Please select a file to upload!", "info");
        setLoading(true);
                    ...
                    <div className='inner'>
                       ...
                       <div className='middleDiv' style={inner}>
                            ...
                            <div style={{marginTop:'30px'}} className='inputs'>
                                ...
                                >
                                    <MenuItem onClick={() => changePay(0, "None")} style={menu} value={0}>Please select a payment method</MenuItem>
                                    <MenuItem onClick={() => changePay(1, "bank")} style={menu} value={1}>Bank</MenuItem>
                                    <MenuItem onClick={() => changePay(2, 'pos')} style={menu} value={2}>Pos</MenuItem>
                                </Select>
                            </div>
