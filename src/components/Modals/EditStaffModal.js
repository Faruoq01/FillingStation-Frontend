...
const EditStaffModal = (props) => {
  ...
  const submit = () => {
    ...
    const detail = {
      ...
      data: payload,
      outletID: singleEmployee.outletID,
      organisationID: singleEmployee.organisationID,
    };

    APIs.post("/hr/employee/update", detail)
      .then(() => {
  ...
  return (
    <Modal
      ...
      <div className="modalContainer2">
        ...
        <div className="inner">
          <div className="head">
            <div className="head-text">Edit Staff Modal</div>
            <img
              onClick={handleClose}
