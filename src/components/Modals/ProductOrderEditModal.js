...
const ProductOrderEditModal = (props) => {
  ...
  const submit = () => {
    ...
    if (depot === "")
      return swal("Warning!", "Depot field cannot be empty", "info");
    if (depotAddress === "")
      return swal("Warning!", "Depot address field cannot be empty", "info");
    if (quantity === "")
    ...
    if (isNaN(Number(quantity)))
      return swal("Warning!", "Quantity field is not a number", "info");
  ...
  return (
    ...
    >
      <div className="modalContainer2">
        <div className="inner">
          <div className="head">
            <div className="head-text">Edit Order</div>
            <img
              onClick={handleClose}
