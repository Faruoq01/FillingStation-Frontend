      ...
      <div style={{ marginTop: "5px" }} className="header_balance_container">
        <div style={ins} className="B_forward">
          ...
          <div className="b_child">
            {props.data === null
              ? "0"
              : ApproximateDecimal(getInit(props).balance)}
          </div>
        </div>
        <div style={ins} className="initial_supply">
          ...
          <div style={{ marginRight: "5px" }} className="b_child">
            {ApproximateDecimal(getInit(props).quantity)}
          </div>
          <div style={{ marginRight: "5px" }} className="b_child">
            {ApproximateDecimal(getInit(props).shortage)}
          </div>
          <div style={{ marginRight: "5px" }} className="b_child">
            {ApproximateDecimal(getInit(props).overage)}
          </div>
          <div className="b_child">
            <Link>View</Link>
          </div>
        ...
        <div style={ins} className="B_forward">
          ...
          <div className="b_child">
            {ApproximateDecimal(
              getInit(props).balance + getInit(props).quantity
            )}
          </div>
        </div>
      </div>
  ...
  const SupplyCard = (props) => {
    return (
      <div className="supply_card">
        <div style={tag}>
          <div style={{ ...tag_name, background: props.color }}>
            {props.type}
          </div>
        </div>
        ...
        <div className="balance_mobile_detail">
          <div className="col_1">
            <div className="mobile_big">
              {balances?.pms === null
                ? "0"
                : ApproximateDecimal(Number(balances?.pms?.balanceCF))}
            </div>
          ...
          <div className="col_1">
            <div className="mobile_big">
              {balances?.ago === null
                ? "0"
                : ApproximateDecimal(Number(balances?.ago?.balanceCF))}
            </div>
          ...
          <div className="col_1">
            <div className="mobile_big">
              {balances?.dpk === null
                ? "0"
                : ApproximateDecimal(Number(balances?.dpk?.balanceCF))}
            </div>
          ...
          <div className="col_1">
            <div className="mobile_big">
              {balances?.pms === null
                ? "0"
                : ApproximateDecimal(
                    Number(balances?.pms?.balanceCF) +
                      Number(
                        getInit({ data: balances?.pms, type: "PMS" }).quantity
                      )
                  )}
            </div>
            <div className="mobile_sm">PMS</div>
          ...
          <div className="col_1">
            <div className="mobile_big">
              {balances?.ago === null
                ? "0"
                : ApproximateDecimal(
                    Number(balances?.ago?.balanceCF) +
                      Number(
                        getInit({ data: balances?.ago, type: "AGO" }).quantity
                      )
                  )}
            </div>
            <div className="mobile_sm">AGO</div>
          ...
          <div className="col_1">
            <div className="mobile_big">
              {balances?.dpk === null
                ? "0"
                : ApproximateDecimal(
                    Number(balances?.dpk?.balanceCF) +
                      Number(
                        getInit({ data: balances?.ago, type: "DPK" }).quantity
                      )
                  )}
            </div>
            <div className="mobile_sm">DPK</div>
