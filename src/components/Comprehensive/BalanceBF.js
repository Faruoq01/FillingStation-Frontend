...
const InitialBalance = () => {
  ...
  const { supply } = useSelector((state) => state.dailysales.supply);
      ...
      <div style={{ marginTop: "5px" }} className="header_balance_container">
        <div style={ins} className="B_forward">
          ...
          <div className="b_child">
            {props.data === null ? "0" : ApproximateDecimal(0)}
          </div>
        </div>
        ...
        <div style={ins} className="B_forward">
          ...
          <div className="b_child">{ApproximateDecimal(0)}</div>
        </div>
      </div>
    );
  };
        ...
        <div className="balance_mobile_detail">
          <div className="col_1">
            <div className="mobile_big">
              {balances?.pms === null ? "0" : ApproximateDecimal(0)}
            </div>
            <div className="mobile_sm">PMS</div>
          </div>
          <div className="col_1">
            <div className="mobile_big">
              {balances?.ago === null ? "0" : ApproximateDecimal(0)}
            </div>
            <div className="mobile_sm">AGO</div>
          </div>
          <div className="col_1">
            <div className="mobile_big">
              {balances?.dpk === null ? "0" : ApproximateDecimal(0)}
            </div>
