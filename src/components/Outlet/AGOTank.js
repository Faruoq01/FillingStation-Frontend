...
const TankComponent = (props) => {
  ...
  useEffect(() => {
    const agoLevel = tankLevelsData.ago.afterSales;
    const capacity =
      tankLevelsData.ago.tankCapacity === 0
        ? 33000
        : tankLevelsData.ago.tankCapacity;
    createTankCanvas(agoLevel, capacity, 200);
  }, [tankLevelsData.ago.afterSales, tankLevelsData.ago.tankCapacity]);
  ...
  return (
    <div className="canvases">
      <Tooltip
        title={`${ApproximateDecimal(tankLevelsData.ago.afterSales)} Litres`}
        followCursor>
        <div>
