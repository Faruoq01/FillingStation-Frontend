    ...
    return (
      <div style={{ height: "400px" }} className="item">
        <div className="inner">
          <div className="top">
            <div className="left">
              ...
              <div style={{ fontWeight: "500" }}>
                {props.data.tankName} ({props.data.productType}){" "}
              </div>
            </div>
            <div className="right">
              <div>
          ...
          <div className="out">
            <div style={{ width: "40%", textAlign: "left", fontWeight: "400" }}>
              Dead Stock Level(Litres)
            </div>
            <OutlinedInput
              placeholder=""
              sx={{
          ...
          <div style={{ marginTop: "20px" }} className="delete">
            ...
            {show === props.data._id && (
              <div style={menus}>
                <div
                  onClick={() => {
                    handleMenuItem("edit", props.data);
                  }}
                  style={menuItem}>
                  Edit
                </div>
                <div
                  onClick={() => {
                    handleMenuItem("delete", props.data);
                  }}
                  style={{
                    ...menuItem,
