                ...
                >
                  ...
                  <span style={{ color: "green", fontSize: "12px" }}>
                    {data.PMSRate === "pending"
                      ? "N 0. 000"
                      : "NGN " +
                        String(Number(data.PMSRate) * Number(data.PMS))}
                  </span>
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  <span style={{ color: "green", fontSize: "12px" }}>
                    {data.AGORate === "pending"
                      ? "N 0. 000"
                      : "NGN " +
                        String(Number(data.AGORate) * Number(data.AGO))}
                  </span>
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  <span style={{ color: "green", fontSize: "12px" }}>
                    {data.DPKRate === "pending"
                      ? "N 0. 000"
                      : "NGN " +
                        String(Number(data.DPKRate) * Number(data.DPK))}
                  </span>
                </div>
                <div style={column2} className="column">
