...
const DailySales = (props) => {
  ...
  const dailyIncoming = useSelector(
    (state) => state.dailySalesReducer.dailyIncoming
  );
  const cummulativeTotals = useSelector(
    (state) => state.dailySalesReducer.cummulative
  );
  const dailySupplys = useSelector(
    (state) => state.dailySalesReducer.dailySupplies
  );
  const currentDate2 = useSelector(
    (state) => state.dailySalesReducer.currentDate
  );
  const [payMe, setPayMe] = useState(false);
  const salesStatus = useSelector(
    (state) => state.dailySalesReducer.salesStatus
  );
  ...
  const getMasterRows = ({ sales, lpo, rtVolumes }) => {
    ...
    const pmsTotals = () => {
      ...
      const pmsPrice = salesPMSData.reduce((accum, current) => {
        return (
          Number(accum) +
          Number(current.sales) * Number(current.PMSSellingPrice)
        );
      }, 0);
      ...
      const pmsTotalDetails = {
        totalDifference: pmsSales,
        totalLpo: pmsLpoSales,
        totalrt: pmsRTSales,
        amount: pmsPrice,
        lpoAmount: pmsLPOPrice,
        noLpoAmount: pmsPrice,
      };
    ...
    const agoTotals = () => {
      ...
      const agoPrice = salesAGOData.reduce((accum, current) => {
        return (
          Number(accum) +
          Number(current.sales) * Number(current.AGOSellingPrice)
        );
      }, 0);
      ...
      const agoTotalDetails = {
        totalDifference: agoSales,
        totalLpo: agoLpoSales,
        totalrt: agoRTSales,
        amount: agoPrice,
        lpoAmount: agoLPOPrice,
        noLpoAmount: agoPrice,
      };
    ...
    const dpkTotals = () => {
      ...
      const dpkPrice = salesDPKData.reduce((accum, current) => {
        return (
          Number(accum) +
          Number(current.sales) * Number(current.DPKSellingPrice)
        );
      }, 0);
      ...
      const dpkTotalDetails = {
        totalDifference: dpkSales,
        totalLpo: dpkLpoSales,
        totalrt: dpkRTSales,
        amount: dpkPrice,
        lpoAmount: dpkLPOPrice,
        noLpoAmount: dpkPrice,
      };
    ...
    if (oneStationData !== null) {
      if (getPerm("0") || getPerm("1") || user.userType === "superAdmin") {
        ...
        DailySalesService.getAllMonthlyReports(payload).then((data) => {
          ...
          dispatch(
            storemonthlyBarData({ expenses: expense, payments: payments })
          );
        });
        return;
      }
  ...
  const getCummulativeVolumePerProduct = (pms, ago, dpk) => {
    ...
    if (today === getDate) {
      ...
      if (totalPMS === 0 && balances?.pms !== 0) {
        ...
        PMSTankCapacity =
          "totalTankCapacity" in balances?.pms
            ? balances?.pms?.totalTankCapacity
            : 33000 * pmsTanks.length;
      }

      if (totalAGO === 0 && balances?.ago !== 0) {
        totalAGO = balances?.ago?.balanceCF;
        AGOTankCapacity =
          "totalTankCapacity" in balances?.ago
            ? balances?.ago?.totalTankCapacity
            : 33000 * agoTanks.length;
      }

      if (totalDPK === 0 && balances?.dpk !== 0) {
        totalDPK = balances?.dpk?.balanceCF;
        DPKTankCapacity =
          "totalTankCapacity" in balances?.dpk
            ? balances?.dpk?.totalTankCapacity
            : 33000 * dpkTanks.length;
      }
    }
  ...
  const getProductTanks = useCallback(() => {
    ...
    const cummulative = getCummulativeVolumePerProduct(
      PMSList,
      AGOList,
      DPKList
    );
      ...
      {props.activeRoute.split("/").length === 3 && (
        <div className="daily-sales-container">
          ...
          {salesStatus.length > 0 && (
            <SalesSuccess open={salesStatus.length > 0} />
          )}
                    ...
                    <div className="dash-details">
                      <div
                        ...
                        <div
                          ...
                          Litre{" "}
                          {ApproximateDecimal(
                            dailySales.hasOwnProperty("PMS")
                              ? Number(dailySales.PMS.total.totalDifference)
                              : 0
                          )}{" "}
                          ltr
                        </div>
                    ...
                    <div className="dash-details">
                      <div
                        ...
                        <div
                          ...
                          {ApproximateDecimal(
                            dailySales.hasOwnProperty("PMS")
                              ? Number(dailySales.AGO.total.totalDifference)
                              : 0
                          )}{" "}
                          ltr
                        </div>
                        <div
                          ...
                          Total NGN{" "}
                          {ApproximateDecimal(
                            dailySales.hasOwnProperty("AGO")
                              ? dailySales.AGO.total.amount
                              : 0
                          )}
                        </div>
                      </div>
                    ...
                    <div className="dash-details">
                      <div
                        ...
                        <div
                          ...
                          {ApproximateDecimal(
                            dailySales.hasOwnProperty("PMS")
                              ? Number(dailySales.DPK.total.totalDifference)
                              : 0
                          )}{" "}
                          ltr
                        </div>
                        <div
                          ...
                          TotaL NGN{" "}
                          {ApproximateDecimal(
                            dailySales.hasOwnProperty("DPK")
                              ? dailySales.DPK.total.amount
                              : 0
                          )}
                        </div>
                      </div>
                ...
                <div className="tank-inner">
                  <div className="tanks">
                    ...
                    <div style={{ fontWeight: "500" }} className="level">
                      Level: {ApproximateDecimal(cummulativeTotals.totalPMS)}{" "}
                      Ltr
                    </div>
                    <div style={{ fontWeight: "500" }} className="capacity">
                      Capacity:{" "}
                      {ApproximateDecimal(cummulativeTotals.PMSTankCapacity)}{" "}
                      Ltr
                    </div>
                    <div
                      onClick={() => {
                  ...
                  <div className="tanks">
                    ...
                    <div style={{ fontWeight: "500" }} className="level">
                      Level: {ApproximateDecimal(cummulativeTotals.totalAGO)}{" "}
                      Ltr
                    </div>
                    <div style={{ fontWeight: "500" }} className="capacity">
                      Capacity:{" "}
                      {ApproximateDecimal(cummulativeTotals.AGOTankCapacity)}{" "}
                      Ltr
                    </div>
                    <div
                      onClick={() => {
                  ...
                  <div className="tanks">
                    ...
                    <div style={{ fontWeight: "500" }} className="level">
                      Level: {ApproximateDecimal(cummulativeTotals.totalDPK)}{" "}
                      Ltr
                    </div>
                    <div style={{ fontWeight: "500" }} className="capacity">
                      Capacity:{" "}
                      {ApproximateDecimal(cummulativeTotals.DPKTankCapacity)}{" "}
                      Ltr
                    </div>
                    <div
                      onClick={() => {
                ...
                {load ? (
                  ...
                  <div className="ins">
                    ...
                    <div>
                      N{" "}
                      {ApproximateDecimal(
                        payments.hasOwnProperty("payments")
                          ? payments.expenses
                          : "0"
                      )}
                    </div>
                ...
                {load ? (
                  ...
                  <>
                    ...
                    <div className="right">
                      ...
                      <div>
                        {ApproximateDecimal(
                          dailySupplys.hasOwnProperty("PMS")
                            ? dailySupplys.PMS
                            : "0"
                        )}
                      </div>
                ...
                {load ? (
                  ...
                  <>
                    ...
                    <div className="right">
                      ...
                      <div>
                        {ApproximateDecimal(
                          dailySupplys.hasOwnProperty("AGO")
                            ? dailySupplys.AGO
                            : "0"
                        )}
                      </div>
                ...
                {load ? (
                  ...
                  <>
                    ...
                    <div className="right">
                      ...
                      <div>
                        {ApproximateDecimal(
                          dailySupplys.hasOwnProperty("DPK")
                            ? dailySupplys.DPK
                            : "0"
                        )}
                      </div>
                  ...
                  <div className="conts">
                    ...
                    <div className="row-count">
                      <div className="item-count">
                        ...
                        {ApproximateDecimal(
                          dailySales.hasOwnProperty("PMS") &&
                            payments.hasOwnProperty("expenses")
                            ? Number(dailySales.PMS.total.noLpoAmount) +
                                Number(dailySales.AGO.total.noLpoAmount) +
                                Number(dailySales.DPK.total.noLpoAmount) -
                                Number(payments.expenses)
                            : "0"
                        )}
                      </div>
                      ...
                      <div style={{ color: "#0872D4" }} className="item-count">
                        NGN{" "}
                        {ApproximateDecimal(
                          payments.hasOwnProperty("oneBankPayment")
                            ? payments.oneBankPayment
                            : "0"
                        )}
                      </div>
                    ...
                    <div className="row-count">
                      ...
                      <div style={{ color: "#000" }} className="item-count">
                        NGN{" "}
                        {ApproximateDecimal(
                          payments.hasOwnProperty("onePosPayment")
                            ? payments.onePosPayment
                            : "0"
                        )}
                      </div>
                      <div className="item-count"></div>
                  ...
                  <div className="conts">
                    ...
                    <div className="row-count">
                      <div className="item-count">
                        ...
                        {ApproximateDecimal(
                          dailySales.hasOwnProperty("PMS")
                            ? Number(dailySales.PMS.total.totalLpo)
                            : "0"
                        )}
                      </div>
                      <div className="item-count">
                        ...
                        {ApproximateDecimal(
                          dailySales.hasOwnProperty("PMS")
                            ? Number(dailySales.PMS.total.lpoAmount)
                            : "0"
                        )}
                      </div>
                    </div>
                    ...
                    <div className="row-count">
                      <div className="item-count">
                        ...
                        {ApproximateDecimal(
                          dailySales.hasOwnProperty("AGO")
                            ? Number(dailySales.AGO.total.totalLpo)
                            : "0"
                        )}
                      </div>
                      <div className="item-count">
                        ...
                        {ApproximateDecimal(
                          dailySales.hasOwnProperty("AGO")
                            ? Number(dailySales.AGO.total.lpoAmount)
                            : "0"
                        )}
                      </div>
                    </div>
                    ...
                    <div className="row-count">
                      <div className="item-count">
                        ...
                        {ApproximateDecimal(
                          dailySales.hasOwnProperty("DPK")
                            ? Number(dailySales.DPK.total.totalLpo)
                            : "0"
                        )}
                      </div>
                      <div className="item-count">
                        ...
                        {ApproximateDecimal(
                          dailySales.hasOwnProperty("DPK")
                            ? Number(dailySales.DPK.total.lpoAmount)
                            : "0"
                        )}
                      </div>
                    </div>
